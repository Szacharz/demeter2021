...
<table class="table table-striped table-bordered text-center table-hover table-responsive"  id="usterki"> 
     <thead>
      <tr>
      <th>LP</th>
      <th>Data</th>
      ...
      <tr>
        ...
        <td class="width: 25%"><a href={{"note/".$row['id_usterki']}}>{{$row['place']}}</td>
        <td class="width: 25%">{{$row['status']}}</td>
        <td class="width: 25%"> {{$row['notki']}} </td>
        <td>
