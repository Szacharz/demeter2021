...
<div class="container-xl">
    ...
    <h1><i class="fa fa-archive"> </i> Archiwum </h1>
    <p> Tabela zawiera wpisy sprzętu uznane za zwrócone. </p>
  </div>
</div>
</div>
</div>
...
<thead class="thead-dark">
      ...
      <tr>
        <td ></td>
        <td style="width:85px"><a href={{"device/".$row['id']}}>{{$row['data']}}</td>
        ...
        <td class= "text-success" >{{$row['finished_at']}}</td>
          <td>
          <a href={{"goback/".$row['id']}} class="btn-sm btn-info">Cofnij</a>
        </td>
      </tr>
