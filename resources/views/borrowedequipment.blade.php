...
@if(Auth::user()->department_id == 1)
         <div class="card">
            ...
            <h1><i class="fa fa-desktop"></i> Pożyczony sprzęt </h1>
  <h3> Sprawdź, jaki sprzęt został wypożyczony </h3>
  </div>
</div>
...
<div class="card-body">
  <div class="float-right">
    <a class="btn btn-info" href='{{url('newdevice')}}' role="button"><h7>  <i class="fa fa-plus"></i>&nbsp;  Dodaj pożyczony sprzęt </h7></a>
    </div>
...
<thead class="thead-dark">
    ...
    <tbody>
        @foreach($device as $row)<tr>
      <td></td>
      <td><a href={{"device/".$row['id']}}>{{$row['data']}}</td>
...
<div class="card-header"><h1><i class="fa fa-shield"></i> Wypożyczony sprzęt </h1></div>
<div class="card-body">
