...
@section('content')
    ...
    @endif
         ...
         <br>
               <div class="card-header"> <h1>Edycja Notatki</h1>
                <p class="description">Edytuj istniejącą notatkę.</p>
               <!-- Input fields -->
                  <div class="card-body">
                   <div class="form-group">
                    <label for="tresc_nt">Treść notatki</label>
                    <textarea  height="100%" class="form-control" id="tresc_nt" placeholder="Podaj treść wpisu..." name="tresc_nt" value=""></textarea>
                </div>
