...
{{-- dodać jeśli akcja po kliknieciu z main.js -> id="notification" --}}
   <span class="float-left text-muted text-sm" style="margin:0px 10px 0px 0px"> <i class="fa fa-envelope mr-2" style="color:green"></i> 

    {{$notification->data['usterkimodel']['data']}}  </span>           <strong>    {{$notification->data['usterkimodel']['autor']}} </strong> dodał nowy wpis. 
